...
const translations = {
  es: {
    ...
    "hero.eyebrow": "Preparado para dar el siguiente paso",
    "hero.role": "Tripulante de Cabina · Cabin Crew",
    "hero.lead": "Servicio cercano. Calma bajo presión. Una nueva trayectoria en aviación.",
    "hero.description": "Aporto varios años de experiencia atendiendo a personas en entornos exigentes y la motivación necesaria para convertir esa base en una carrera profesional a bordo.",
    ...
    "proof.growthTitle": "Mentalidad de mejora",
    "proof.growthText": "Preparación constante para aviación",
    "about.kicker": "Perfil",
    "about.title": "La atención a las personas ha sido siempre el centro de mi trabajo.",
    "about.intro": "Ahora quiero llevar esa experiencia a un entorno donde servicio, seguridad y trabajo en equipo avanzan en la misma dirección.",
    ...
    "about.fact3": "Disponible para movilidad y nuevos retos.",
    ...
    "motivation.quote": "“Servicio y seguridad no son ideas separadas: ambos empiezan por prestar atención.”",
    "experience.kicker": "Trayectoria",
    "experience.title": "Experiencia que sí cuenta a bordo",
    ...
    "skills.title": "Preparado para atender. Dispuesto a aprender.",
    ...
    "aviation.lead": "Presentarme al proceso de selección de Lauda fue una decisión consciente para acercarme a la profesión y conocer sus exigencias de primera mano.",
    "aviation.body": "A principios de 2026 participé en un proceso real de selección para tripulantes de cabina. No superé el examen teórico por un margen reducido, pero la experiencia me permitió identificar con claridad qué conocimientos debía reforzar y comprender mejor el nivel de preparación requerido. Lejos de frenar mi objetivo, ese aprendizaje aumentó mi motivación para continuar preparándome y volver a presentarme con una base más sólida.",
    "aviation.pathLabel": "Aprendizajes del proceso",
    "aviation.step1Title": "Iniciativa",
    "aviation.step1Text": "Dar el primer paso",
    ...
    "contact.title": "Hablemos de la próxima oportunidad.",
  ...
  en: {
    ...
    "hero.eyebrow": "Ready to take the next step",
    "hero.role": "Cabin Crew · Flight Attendant",
    "hero.lead": "Personal service. Calm under pressure. A new path in aviation.",
    "hero.description": "I bring several years of experience helping people in demanding environments and the motivation to turn that background into a professional career on board.",
    ...
    "proof.growthTitle": "Growth mindset",
    "proof.growthText": "Continuous preparation for aviation",
    "about.kicker": "Profile",
    "about.title": "Looking after people has always been at the centre of my work.",
    "about.intro": "Now I want to bring this experience to an environment where service, safety and teamwork move in the same direction.",
    ...
    "about.fact3": "Available for relocation and new challenges.",
    ...
    "motivation.quote": "“Service and safety are not separate ideas: both begin by paying attention.”",
    "experience.kicker": "Background",
    "experience.title": "Experience that matters on board",
    ...
    "skills.title": "Ready to serve. Willing to learn.",
    ...
    "aviation.lead": "Taking part in the Lauda recruitment process was a conscious decision to get closer to the profession and understand its requirements first-hand.",
    "aviation.body": "At the beginning of 2026, I took part in a real cabin crew recruitment process. I did not pass the theory exam by a narrow margin, but the experience helped me identify the knowledge I needed to strengthen and better understand the level of preparation required. Instead of stopping my goal, this lesson increased my motivation to continue preparing and apply again with a stronger foundation.",
    "aviation.pathLabel": "Lessons from the process",
    "aviation.step1Title": "Initiative",
    "aviation.step1Text": "Taking the first step",
